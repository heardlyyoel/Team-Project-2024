...
if (!$stmt) {
    echo "Error in prepare statement: " . $conn->errorInfo()[2];
    exit();
}
                    ...
                    <div class="card h-100">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="book_detail.php?book_id=<?php echo $book['book_id']; ?>" class="btn btn-primary">See More</a>  
                            </div>
                        </div>
                    </div>
                </div>
...
// Query to get  semua kategori dari tabel category
